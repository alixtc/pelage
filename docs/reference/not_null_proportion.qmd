...
<code><span class="parameter-name">items</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[Dict](`Dict`)\[[str](`str`), [float](`float`) \| [Tuple](`Tuple`)\[[float](`float`), [float](`float`)\]\]</span></code>
