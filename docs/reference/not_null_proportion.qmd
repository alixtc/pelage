# not_null_proportion { #pelage.not_null_proportion }

```python
not_null_proportion(data, items, group_by=None)
```
...
<code><span class="parameter-name">items</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[Dict](`typing.Dict`)\[[str](`str`), [float](`float`) \| [Tuple](`typing.Tuple`)\[[float](`float`), [float](`float`)\]\]</span></code>
