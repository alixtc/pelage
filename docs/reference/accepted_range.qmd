...
<code><span class="parameter-name">items</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[Dict](`typing.Dict`)\[[str](`str`), [PolarsColumnBounds](`pelage.checks.utils.types.PolarsColumnBounds`)\]</span></code>
