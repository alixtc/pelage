...
<code><span class="parameter-name">items</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[Dict](`Dict`)\[[str](`str`), [PolarsColumnBounds](`pelage.types.PolarsColumnBounds`)\]</span></code>
