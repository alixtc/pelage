...
<code><span class="parameter-name">items</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[Tuple](`Tuple`)\[[PolarsColumnType](`pelage.types.PolarsColumnType`), [int](`int`)\]</span></code>
