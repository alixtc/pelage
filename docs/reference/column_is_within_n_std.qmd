...
<code><span class="parameter-name">items</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[Tuple](`typing.Tuple`)\[[PolarsColumnType](`pelage.checks.utils.types.PolarsColumnType`), [int](`int`)\]</span></code>
