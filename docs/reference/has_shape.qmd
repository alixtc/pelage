...
<code><span class="parameter-name">shape</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[Tuple](`Tuple`)\[[IntOrNone](`pelage.types.IntOrNone`), [IntOrNone](`pelage.types.IntOrNone`)\]</span></code>
