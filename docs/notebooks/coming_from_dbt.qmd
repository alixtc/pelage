...
`pelage` was designed in order to reduce the gap between data exploration and
production. Working on data related use-cases implies facing many different challenges,
one the majors are data quality, data drift.
 ...
 - During EDA, data visualization plays a crucial role to identify relevant data or
