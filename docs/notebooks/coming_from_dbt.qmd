...
|:---------------:|:-------------------------:|:-----------------:|
|     unique      |            ✅             |        ✖️         |
|    not_null     |      has_no_nulls ✅      |        ✖️         |
| accepted_values |            ✅             |        ✖️         |
|  relationship   | maintains_relationship ✅ |        ✖️         |
...
|        fewer_rows_than        |          ❌           |        ❌         |
|           equality            |          ❌           |        ❌         |
|      expression_is_true       |    custom_check ✅    |  custom_check ✅  |
|            recency            |          ❌           |        ❌         |
|         at_least_one          |          ✅           |        ✖️         |
|         not_constant          |          ✅           |        ✅         |
|       not_empty_string        |          ❌           |        ❌         |
|     cardinality_equality      |          ✅           |        ✅         |
|      not_null_proportion      |          ✅           |        ✖️         |
|      not_accepted_values      |          ✅           |        ✖️         |
|      relationships_where      |          ❌           |        ❌         |
|   mutually_exclusive_ranges   |          ✅           |        ✅         |
|       sequential_values       |    is_monotonic ✅    |  is_monotonic ✅  |
| unique_combination_of_columns |          ✅           |        ✖️         |
|        accepted_range         |          ✅           |        ✖️         |
